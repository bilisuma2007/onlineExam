...
#start
{
    ...
    ?>
        <h2 id="title">   <img  src="image/avatara.jpg.jpg" alt="test icon"  id="avator" >Online Examination System -Student DashBoard</h2>
	   ...
	   <div id="start" >
               <h3>To start the test click start</h3>
               <center >
                   
                   <a href="studstartquiz.php"> <input type="button"   class="btn btn-primary"  value="Start"/>
               </center>
           </div>
