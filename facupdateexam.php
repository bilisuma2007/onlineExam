        ...
        <div class="vnav">
               ...
               <div class="sidebar">
                    ...
                    <ul>
                        ...
                        <li><a href ="adminstudentlist.php" id="onlink" ><img src="icons/student.ico" alt="student icon" class="icon" id="icon2"/>Students</a></li>
        ...
        <div class="mainc">
            ...
            <div class="tabcon">
              ...
              <div class="table-responsive"> 
               <h2> List of Students Registerd for Exam </h2>
                <center>
            ...
            <tbody>
   <?php
              $query= ' select id , fullname, gender,phone, username,password from student';
                ...
                if ($result->num_rows >0)
                {
                  while ($row=$result->fetch_assoc()){
                   ...
                   .$row["phone"]."</td><td>".$row["username"]."</td><td>".$row["password"]."</td></tr>";
                  }
                }
...
$(document).ready(function(){  
     $('#editable_table').Tabledit({
      ...
      columns:{
       identifier:[0, "id"],
       editable:[[1, 'fullname'], [2, 'gender'], [3, 'phone'], [4, 'username'],[5, 'password']]
      },
      restoreButton:false,
